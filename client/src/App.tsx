  ...
  return <div className="product-landing">
    <header className="product-nav">
      ...
      <nav className="product-nav-links" aria-label="Product navigation">
        <a href="#product">Product</a><a href="#lifecycle">How it works</a><a href="#security">Security</a><a href="#use-cases">Use cases</a><a href="#developers">Developers</a><a href="#enterprise">Enterprise</a><a href="https://github.com/Shaurya2k06/AIRLOCK/blob/main/README.md" target="_blank" rel="noreferrer">Documentation</a>
      </nav>
    ...
    <main>
      ...
      <section className="product-section product-container developers-section" id="developers"><div className="section-intro"><p className="product-kicker">DEVELOPER INTEGRATION</p><h2>Ship the release. Prove it. Receive authority.</h2><p>Use the manifest CLI, contract interfaces, and router flow to move from build output to a bounded capability.</p></div><div className="developer-grid"><div className="developer-steps">{[['01','Build','Create the canonical artifact manifest.'],['02','Publish','Write the release and evaluation evidence.'],['03','Approve','Register deployment parameters and policy.'],['04','Issue','Wait for verified evidence, then receive a capability.'],['05','Act','Submit typed intents through the router.']].map(([number,title,copy]) => <div key={number}><span>{number}</span><div><strong>{title}</strong><p>{copy}</p></div></div>)}</div><div className="code-card"><div className="code-card-top\"><span>airlock / terminal</span><span><i /> verified path</span></div><pre><code>{'airlock manifest build\\n  --input ./release\\n  --output ./airlock-manifest.json\\n\\nairlock release publish\\n  --manifest ./airlock-manifest.json\\n\\nairlock capability inspect\\n  --release $RELEASE_DIGEST'}</code></pre><div className="code-card-links"><a href="https://github.com/Shaurya2k06/AIRLOCK/blob/main/contracts/scripts/manifest.mjs" target="_blank" rel="noreferrer">Manifest CLI <Icon name="external" size={13} /></a><a href="https://github.com/Shaurya2k06/AIRLOCK/blob/main/contracts/contracts/Airlock.sol" target="_blank" rel="noreferrer">Contract interfaces <Icon name="external" size={13} /></a><a href="https://github.com/Shaurya2k06/AIRLOCK/blob/main/docs/architecture.md" target="_blank" rel="noreferrer">Architecture <Icon name="external" size={13} /></a></div></div></div></section>
      ...
      <section className="product-section product-container network-section"><div className="network-panel"><div><p className="product-kicker">SUPPORTED NETWORKS</p><h2>One supported path today. More adapters when they are proven.</h2></div><table><thead><tr><th>Source</th><th>Verification path</th><th>Status</th></tr></thead><tbody><tr><td>Ethereum Sepolia</td><td>Attestcoin → Creditcoin</td><td><span className="table-status"><i /> available</span></td></tr><tr><td>Ethereum mainnet</td><td>Attestcoin → Creditcoin</td><td><span className="table-status planned"><i /> planned</span></td></tr><tr><td>Other chains</td><td>Chain-specific adapters</td><td><span className="table-status planned"><i /> roadmap</span></td></tr></tbody></table></div></section>
