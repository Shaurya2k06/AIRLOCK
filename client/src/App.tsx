  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        {activeNav !== 'Overview' && <DetailView activeNav={activeNav} onBack={() => setActiveNav('Overview')} evidenceItems={displayEvidence} capability={displayCapability} activity={displayActivity} fixtureMode={!liveData && !chainUnavailable} />}
      </main>
    </div>
  )
}

function DetailView({ activeNav, onBack, evidenceItems, capability, activity: displayActivity, fixtureMode }: { activeNav: string; onBack: () => void; evidenceItems: DisplayEvidence[]; capability?: Overview['capability']; activity: Array<{ action: string; target: string; amount: number | string; state: string; age: string }>; fixtureMode: boolean }) {
